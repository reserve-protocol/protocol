  ...
  describe('Recapitalization', function () {
    context('With very simple Basket - Single stablecoin', async function () {
      ...
      it('Should recapitalize correctly in case of default - Using RSR for remainder - Multiple tokens and auctions - No overshoot', async () => {
        ...
        let sellAmtBkp: BigNumber = requiredBkpToken // Will auction only what is required
        let minBuyAmtBkp: BigNumber = sellAmtBkp // No trade slippage
        ...
        let buyAmtBidRSR: BigNumber = requiredBkpToken.sub(minBuyAmtBkp1Remainder)
    ...
    context('With issued Rtokens', async function () {
      ...
      it('Should recapitalize correctly in case of default - Taking Haircut - Single backup token', async () => {
        ...
        let sellAmt2: BigNumber = await token2.balanceOf(backingManager.address)
        let sellAmt3: BigNumber = (await token3.balanceOf(backingManager.address)).mul(pow10(10)) // convert to 18 decimals for simplification
