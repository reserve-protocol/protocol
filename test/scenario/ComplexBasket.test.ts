...
describe(`Complex Basket - P${IMPLEMENTATION}`, () => {
  ...
  let cUSDTokenVault: CTokenVaultMock2
  let aUSDToken: StaticATokenMock
  let wbtc: ERC20Mock
  let cWBTCVault: CTokenVaultMock2
  let cETHVault: CTokenVaultMock2
  ...
  beforeEach(async () => {
    ...
    const CToken: ContractFactory = await ethers.getContractFactory('CTokenVaultMock2')
    ...
    cUSDTokenVault = <CTokenVaultMock2>erc20s[4] // cDAI Token
