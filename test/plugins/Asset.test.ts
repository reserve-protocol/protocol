...
describe('Assets contracts #fast', () => {
  ...
  describe('Prices', () => {
    ...
    it('Should revert if price is zero', async () => {
      ...
      // Check new prices
      await expect(rsrAsset.price()).to.be.revertedWith('InvalidOraclePrice()')
      await expect(compAsset.price()).to.be.revertedWith('InvalidOraclePrice()')
      await expect(aaveAsset.price()).to.be.revertedWith('InvalidOraclePrice()')
    })
  })
})
