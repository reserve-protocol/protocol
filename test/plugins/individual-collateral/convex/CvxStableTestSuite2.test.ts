...
describeFork(`Collateral: Convex`, () => {
  ...
  describe('collateral functionality', () => {
    ...
    beforeEach(async () => {
      ...
      ;({ chainlinkFeed, collateral, usdcFeed, daiFeed, usdtFeed, w3Pool } = ctx)

      await mintW3Pool(ctx, bn('100e18'), wallet, wallet.address)
    })
    ...
    describe('prices', () => {
      it('prices change as feed price changes', async () => {
        ...
        // TODO: every combination of oracle
      ...
      it('prices change as refPerTok changes', async () => {
        ...
        // TODO: Ask Taylor if this is fine
    ...
    describe('status', () => {
      ...
      it('enters DISABLED state when refPerTok() decreases', async () => {
        ...
        console.log(ctx.curvePool.address, await collateral.curvePool())
