...
export const defaultCrvVolatileCollateralOpts: CurveCollateralOpts = {
  erc20: ZERO_ADDRESS,
...
export const deployCollateral = async (
  ...
  opts = { ...defaultCrvVolatileCollateralOpts, ...opts }

  const CrvVolatileCollateralFactory: ContractFactory = await ethers.getContractFactory(
    'CurveVolatileCollateral'
  )

  const collateral = <TestICollateral>await CrvVolatileCollateralFactory.deploy(
    {
      erc20: opts.erc20,
...
const makeCollateralFixtureContext = (
  ...
  const collateralOpts = { ...defaultCrvVolatileCollateralOpts, ...opts }
...
const opts = {
  ...
  isMetapool: false,
  resetFork,
  collateralName: 'CurveVolatileCollateral  - CurveGaugeWrapper',
}
