...
export const deployCollateral = async (
  ...
  const CrvStableCollateralFactory = await ethers.getContractFactory(
    'CurveStableMetapoolCollateral'
  )

  const collateral = <CurveStableMetapoolCollateral>await CrvStableCollateralFactory.deploy(
    {
      erc20: opts.erc20!,
...
const opts = {
  ...
  isMetapool: true,
  resetFork,
  collateralName: 'CurveStableMetapoolCollateral - CurveVault',
}
