...
// Mainnet Addresses
export const RSR = networkConfig['31337'].tokens.RSR
export const USDC_USD_PRICE_FEED = networkConfig['31337'].chainlinkFeeds.USDC
export const CUSDC_V3 = networkConfig['31337'].tokens.cV3USDC
export const COMP = networkConfig['31337'].tokens.COMP
export const REWARDS = '0x1B0e765F6224C21223AeA2af16c1C46E38885a40'
export const USDC = networkConfig['31337'].tokens.USDC
