...
export const defaultWSUPEROETHBCollateralOpts: WSUPEROETHBCollateralOpts = {
    ...
    targetPerTokChainlinkFeed: BASE_PRICE_FEEDS.wsuperOETHb_ETH,
...
const makeCollateralFixtureContext = (
    ...
    const makeCollateralFixtureContext = async () => {
        ...
        const uoaPerTargetChainlinkFeed = await MockV3AggregatorFactory.deploy(8, defaultAnswers.uoaPerTargetChainlinkFeed)
        ...
        const wsuperOETHb = (await ethers.getContractAt('IWSuperOETHb', BASE_WSUPEROETHB)) as IWSuperOETHb
...
const reduceRefPerTok = async (ctx: WSUPEROETHBCollateralFixtureContext, pctDecrease: BigNumberish) => {
    const slot = 2
