...
describe('Collateral contracts', () => {
  ...
  describe('Deployment', () => {
    it('Deployment should setup collateral correctly #fast', async () => {
      ...
      expect(await tokenCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
      ...
      expect(await usdcCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
      ...
      expect(await aTokenCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
      ...
      expect(await cTokenCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
  ...
  describe('Non-fiat Collateral #fast', () => {
    ...
    it('Should setup collateral correctly', async function () {
      ...
      expect(await nonFiatCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
  ...
  describe('CToken Non-fiat Collateral #fast', () => {
    ...
    it('Should setup collateral correctly', async function () {
      ...
      expect(await cTokenNonFiatCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
  ...
  describe('Self-Referential Collateral #fast', () => {
    ...
    it('Should setup collateral correctly', async function () {
      ...
      expect(await selfReferentialCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
  ...
  describe('CToken Self-Referential Collateral #fast', () => {
    ...
    it('Should setup collateral correctly', async function () {
      ...
      expect(await cTokenSelfReferentialCollateral.oracleTimeout()).to.equal(
        ORACLE_TIMEOUT_WITH_BUFFER
      )
  ...
  describe('EUR fiat Collateral #fast', () => {
    ...
    it('Should setup collateral correctly', async function () {
      ...
      expect(await eurFiatCollateral.oracleTimeout()).to.equal(ORACLE_TIMEOUT_WITH_BUFFER)
