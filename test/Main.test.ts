...
describe(`MainP${IMPLEMENTATION} contract`, () => {
  ...
  describe('Deployment #fast', () => {
    ...
    it('Should register ERC20s and Assets/Collateral correctly', async () => {
      ...
      expect(ERC20s.length).to.eql((await facade.basketTokens(main.address)).length + 4)
    ...
    it('Should register Basket correctly', async () => {
      ...
      const backing = await facade.basketTokens(main.address)
  ...
  describe('Configuration/State #fast', () => {
    ...
    it('Should return backing tokens', async () => {
      expect(await facade.basketTokens(main.address)).to.eql([
        token0.address,
        token1.address,
        token2.address,
        token3.address,
  ...
  describe('Basket Handling', () => {
    ...
    it('Should handle full collateral deregistration and reduce to empty basket', async () => {
      ...
      let toks = await facade.basketTokens(main.address)
      ...
      toks = await facade.basketTokens(main.address)
