...
describeFork(`ETokenSelfReferentialCollateral - Mainnet Forking P${IMPLEMENTATION}`, function () {
  ...
  let eTokenCollateral: ETokenSelfReferentialCollateral
  ...
  describe('Issuance/Appreciation/Redemption', () => {
    ...
    it('Should issue, redeem, and handle appreciation rates correctly', async () => {
      ...
      //console.log("eTokenRefPerTok3: ", eTokenRefPerTok3)
  ...
  describe('Collateral Status', () => {
    ...
    it('Updates status in case of hard default', async () => {
      ...
      const neweTokenCollateral: ETokenSelfReferentialCollateral = <ETokenSelfReferentialCollateral>await (
        await ethers.getContractFactory('ETokenSelfReferentialCollateral', {
          libraries: { OracleLib: oracleLib.address },
        })
      ).deploy(
    ...
    it('Reverts if oracle reverts or runs out of gas, maintains status', async () => {
      ...
      console.log(
        '\n',
        '[ETokenSelfReferentialCollateral] Testing Done', '\n',
        '\n',
        )
    })
  })
