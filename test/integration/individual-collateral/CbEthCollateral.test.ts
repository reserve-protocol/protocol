  ...
  describe('Deployment', () => {
    ...
    describe('Price Handling', () => {
      it('Should handle invalid/stale Price', async () => {
        ...
        const invalidpriceCbEthCollateral: CbEthCollateral = <CbEthCollateral>await (
        ...
        const nonpriceCbEthCollateral: CbEthCollateral = <CbEthCollateral>await (
          await ethers.getContractFactory('CbEthCollateral', {
            libraries: { OracleLib: oracleLib.address },
          })
        ).deploy(
    ...
    describe('Collateral Status', () => {
      ...
      it('Updates status in case of hard default', async () => {
        ...
        const CbEthMockFactory = await ethers.getContractFactory('CBEthMock')
