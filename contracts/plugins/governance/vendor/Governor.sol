...
// This contract is based on OZ Governor 4.9.6
// The only change is to expose an additional proposalProposedAt() view function
    ...
    IERC1155Receiver
{
    ...
    function proposalProposedAt(uint256 proposalId) public view virtual returns (uint256) {
        return _proposals[proposalId].proposedAt;
    }
    ...
    function propose(
        ...
        _proposals[proposalId] = ProposalCore({
            proposer: proposer,
            proposedAt: SafeCast.toUint64(currentTimepoint),
