 ...
 * @notice Collateral plugin for a cToken of a self-referential asset, like eWETH or eUNI.
...
contract ETokenSelfReferentialCollateral is Collateral {
    ...
    // testing purpose: Target Price e.g ETH Price
    function latestTargetPrice() public view returns (uint192) {
