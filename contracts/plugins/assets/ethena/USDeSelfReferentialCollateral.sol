...
/**
 * @title USDe Self Referential Collateral
 ...
 * UoA = USD
 *
 *  {tok} != {ref}, {ref} == {target}, {target} != {UoA}
 */

contract USDeSelfReferentialCollateral is ERC4626FiatCollateral {
    using FixLib for uint192;
    using OracleLib for AggregatorV3Interface;

    /// config.erc20 must be sUSDe ERC4626 vault
