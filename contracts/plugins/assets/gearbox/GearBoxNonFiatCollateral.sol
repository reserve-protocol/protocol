...
/**
 * @title GearBoxNonFiatCollateral
 ...
 * UoA = USD
 */
contract GearBoxNonFiatCollateral is AppreciatingFiatCollateral {
    ...
    /// @param config.chainlinkFeed Feed units: {UoA/ref == UoA/tok}
    constructor(
        ...
        )
    {
        ...
        pegPrice = targetPerRef(); // ETH/WETH is considered to be always 1
    }
