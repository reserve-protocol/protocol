...
contract UnpricedAssetMock is Asset {
    ...
    ) Asset(priceTimeout_, uoaPerRefOracle_, oracleError_, erc20_, maxTradeVolume_, uoaPerRefOracleTimeout_) {}
...
contract UnpricedAppreciatingCollateralMock is AppreciatingCollateral {
    using FixLib for uint192;
    using OracleLib for AggregatorV3Interface;
        ...
        )
    {
        ...
        pegPrice = uoaPerRefOracle.price(uoaPerRefOracleTimeout);
