...
library FixLib {
    ...
    function div(
        ...
        uint256 shiftedX = uint256(x) * FIX_SCALE;
    ...
    /// Rounding: intermediate muls do nearest-value rounding. Anything else gets weird quick.
    ...
    function near(
        ...
        int256 x = int256(int192(x_));
        int256 y = int256(int192(y_));
        int256 diff = x - y;
