...
interface ProtoCommon {
    ...
    function setBaseAssetPrices(AssetName[] memory assets, OraclePrice[] memory prices) external;

    /// Updates DeFi redemption rates
    /// @param defiAssets CTokens and ATokens
    function setDefiCollateralRates(AssetName[] memory defiAssets, Fix[] memory fiatcoinRedemptionRates)
        external;
