...
interface IVault {
    ...
    /// @param BUs {qBU} The quantity of BUs issued, as the raw Fix, i.e. 1e18{qBUs}
    ...
    /// @param BUs {qBU} The quantity of BUs redeemed, as the raw Fix, i.e. 1e18{qBUs}
    ...
    /// @param BUs {qBU} The quantity of BUs transferred, as the raw Fix, i.e. 1e18{qBUs}
