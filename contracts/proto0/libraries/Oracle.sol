...
library Oracle {
    ...
    function consultAave(Oracle.Info storage self, address token) public view override returns (uint256) {
    ...
    // Returns the USD price with 18 decimals
    function consultCompound(Oracle.Info storage self, address token) public view override returns (uint256) {
