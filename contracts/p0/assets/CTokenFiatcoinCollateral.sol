...
contract CTokenFiatcoinCollateralP0 is CompoundOracleMixinP0, CollateralP0 {
    ...
    function claimAndSweepRewards(ICollateral collateral, IMain main_) external virtual override {
        ...
        CTokenFiatcoinCollateralP0(address(collateral)).comptroller().claimComp(address(this));
