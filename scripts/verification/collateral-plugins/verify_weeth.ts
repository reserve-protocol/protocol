...
async function main() {
  ...
  await verifyContract(
    ...
    [
      ...
      WEETH_ORACLE_TIMEOUT.toString(), // targetPerTokChainlinkTimeout
    ],
    'contracts/plugins/assets/etherfi/WeEthCollateral.sol:WeEthCollateral'
  )
}
