    ...
    await verifyContract(
      ...
      [
        ...
        revenueHiding.toString(),
        {
          ...
          poolType: CurvePoolType.Plain,
          feeds: [[ARB_USDT_USD_FEED], [crvUSD_USD_FEED]],
          oracleTimeouts: [[ARB_USDT_ORACLE_TIMEOUT], [crvUSD_ORACLE_TIMEOUT]],
          oracleErrors: [[ARB_USDT_ORACLE_ERROR], [crvUSD_ORACLE_ERROR]],
