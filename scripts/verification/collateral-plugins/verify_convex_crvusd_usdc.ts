    ...
    await verifyContract(
      ...
      [
        ...
        revenueHiding.toString(),
        {
          ...
          feeds: [[crvUSD_USD_FEED], [USDC_USD_FEED]],
          oracleTimeouts: [[crvUSD_ORACLE_TIMEOUT], [USDC_ORACLE_TIMEOUT]],
          oracleErrors: [[crvUSD_ORACLE_ERROR], [USDC_ORACLE_ERROR]],
          lpToken: crvUSD_USDC,
        },
      ],
    ...
    await verifyContract(
      ...
      [
        ...
        revenueHiding.toString(),
        {
          ...
          poolType: CurvePoolType.Plain,
          feeds: [[crvUSD_USD_FEED], [ARB_USDC_USD_FEED]],
          oracleTimeouts: [[crvUSD_ORACLE_TIMEOUT], [ARB_USDC_ORACLE_TIMEOUT]],
          oracleErrors: [[crvUSD_ORACLE_ERROR], [ARB_USDC_ORACLE_ERROR]],
