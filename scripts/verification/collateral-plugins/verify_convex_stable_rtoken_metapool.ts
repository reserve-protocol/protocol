...
async function main() {
  ...
  await verifyContract(
    ...
    [
      {
        ...
        oracleTimeout: oracleTimeout(chainId, USDC_ORACLE_TIMEOUT),
    ...
    'contracts/plugins/assets/curve/CurveStableRTokenMetapoolCollateral.sol:CurveStableRTokenMetapoolCollateral'
  )
}
