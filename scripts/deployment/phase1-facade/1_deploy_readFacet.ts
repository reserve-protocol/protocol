...
async function main() {
  ...
  // Deploy ReadFacet
  const FacadeActFactory = await ethers.getContractFactory('ReadFacet')

  readFacet = <ReadFacet>await FacadeActFactory.connect(burner).deploy()
  await readFacet.deployed()

  // Write temporary deployments file
  deployments.readFacet = readFacet.address
