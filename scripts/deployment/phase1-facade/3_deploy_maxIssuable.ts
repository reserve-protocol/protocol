...
async function main() {
  ...
  // ******************** Deploy MaxIssuableFacet ****************************************/

  // Deploy MaxIssuableFacet
  const MaxIssuableFacetFactory = await ethers.getContractFactory('MaxIssuableFacet')
  maxIssuableFacet = <MaxIssuableFacet>await MaxIssuableFacetFactory.connect(burner).deploy()
  await maxIssuableFacet.deployed()

  // Write temporary deployments file
  deployments.facets.maxIssuableFacet = maxIssuableFacet.address
